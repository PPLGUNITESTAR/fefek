 ...
 */
unsigned int sysctl_sched_latency			= 4000000ULL; /* Watt: Tuned for UI smoothness */
unsigned int normalized_sysctl_sched_latency		= 4000000ULL; /* Watt: Tuned for UI smoothness */
 ...
 */
unsigned int sysctl_sched_min_granularity		= 500000ULL; /* Watt: Tuned for UI smoothness */
unsigned int normalized_sysctl_sched_min_granularity	= 500000ULL; /* Watt: Tuned for UI smoothness */
